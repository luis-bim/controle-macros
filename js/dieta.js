...
export function renderDieta() {
    return `
        <div class="card">
            ...
            <div class="config-meta" style="display:flex; justify-content:space-between; margin-bottom:15px; font-size:11px;">
                <span>META DIARIA (g):</span>
                <input type="number" id="meta-diaria" value="${meta}" style="background:var(--fundo-preto); color:white; border:1px solid var(--borda-fina); width:60px;">
            </div>
            ...
            <button class="btn-reset" id="btn-reset-dieta" style="background:transparent; color:#666; border:1px solid var(--borda-fina); width:100%; padding:10px; margin-top:20px; font-size:10px; cursor:pointer;">APAGAR REGISTROS DO DIA</button>
        </div>
    `;
}

export async function initDieta() {
    // Carregar Excel com o novo caminho
    try {
